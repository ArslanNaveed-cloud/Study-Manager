...
// Set up the buttons
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.edit_nav:
                Toast.makeText(this, "Please Select a file to update", Toast.LENGTH_SHORT).show();
                if(adaphter == null){
                    Toast.makeText(CollectionActivity.this, "Please add data", Toast.LENGTH_SHORT).show();
                }else {
                     isedit_mode = true;
                        ...
                        try {
                            ...
                            if (status.equals("500")) {
                                ...
                                Toast.makeText(CollectionActivity.this,"No Record was found",Toast.LENGTH_LONG).show();
                                 ...
                                 UpdateSizeVolleyRequest(collectionDataModels);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private void UpdateSizeVolleyRequest(final ArrayList<CollectionDataModel> collectionDataModels) {
        dialog = ProgressDialog.show(CollectionActivity.this, "Please Wait",
                "Deleting Data...");
        dialog.show();
