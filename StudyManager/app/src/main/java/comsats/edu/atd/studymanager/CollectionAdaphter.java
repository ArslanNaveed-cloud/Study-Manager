...
public class CollectionAdaphter extends RecyclerView.Adapter<CollectionAdaphter.viewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, final int position) {
        ...
        String sub_string1 = collectionname.substring(0,1).toUpperCase();
        String sub_string2 = collectionname.substring(1);

        String main = sub_string1+sub_string2.trim();

        holder.collectionname.setText(main);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("500")) {
                                ...
                                buildDialogdatachanged(context, "Collection already exists", "Please Choose another name").show();
