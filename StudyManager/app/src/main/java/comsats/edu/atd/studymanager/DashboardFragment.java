...
public class DashboardFragment extends Fragment {
    ...
    private TextView collection, file, quiz, assignment,totalsize;
    private String collec_length, file_length, quiz_length, assignment_length,size_length,size;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        totalsize = view.findViewById(R.id.size_length);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            size_length = reader.getString("size");

                            double double_size = Double.parseDouble(size_length);
                            double_size = double_size/1024;
                            String placeholder = String.format("%.4f",double_size);
                            collection.setText(collec_length);
                            file.setText(file_length);
                            quiz.setText(quiz_length);
                            assignment.setText(assignment_length);

                            totalsize.setText(placeholder+" / "+"2gb");
                            loader.setVisibility(View.GONE);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            float mysize = Float.parseFloat(size);
                            SharedPreferences sharedPreferences = getActivity().getSharedPreferences("userInfo",Context.MODE_PRIVATE);

                            SharedPreferences.Editor editor = sharedPreferences.edit();
                            editor.putFloat("size",mysize);
                            editor.apply();
