   ...
   private static String collectionname;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode ==1
            ...
            progressDialog = new ProgressDialog(SelectPhoto.this);
    ...
    public void VolleyRequest1() {
        ...
        dialog = ProgressDialog.show(SelectPhoto.this, "Please Wait",
                "Saving Data...");
        dialog.show();
        RequestQueue queue = Volley.newRequestQueue(SelectPhoto.this);
    ...
    public AlertDialog.Builder buildDialog(Context c, String header, String message) {
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(SelectPhoto.this,DashboardActivity.class);
    ...
    public AlertDialog.Builder buildDialogdatachanged(Context c, String header, String message) {
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(SelectPhoto.this,EnterFileContents.class);
                startActivity(intent);
                finish();
            }
        });
