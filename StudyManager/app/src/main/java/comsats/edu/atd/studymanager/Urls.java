...
public class Urls {
    ...
    public static String UPDATESIZE = "http://" + DOMAIN1 + "/collectiondeleted";
    ...
    public static String GET_SIZE = "http://" + DOMAIN1 + "/getsize";
    ...
    public static String UPDATE_SIZE= "http://" + DOMAIN1 + "/updatesize";
