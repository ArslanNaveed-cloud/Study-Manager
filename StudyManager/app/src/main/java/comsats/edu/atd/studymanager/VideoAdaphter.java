...
public class VideoAdaphter extends RecyclerView.Adapter<VideoAdaphter.viewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, final int position) {
        ...
        final String filetitle = arrayList.get(position).getFiletitle().toUpperCase();
        String sub_string1 = filename.substring(0,1).toUpperCase();
        String sub_string2 = filename.substring(1);

        String main = sub_string1+sub_string2.trim();
    ...
    public void VolleyRequest1(final String m_Text, final String username) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("500")) {
                                ...
                                buildDialogdatachanged(context, "File already exists", "Please choose a different name").show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String collection = viewVideos.collectionname;
