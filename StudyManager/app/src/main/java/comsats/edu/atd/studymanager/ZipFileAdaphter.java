...
public class ZipFileAdaphter extends RecyclerView.Adapter<ZipFileAdaphter.viewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull final viewHolder holder, final int position) {
        final String filename = arrayList.get(position).getFilename().toUpperCase();
    ...
    public void VolleyRequest1(final String m_Text, final String username) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("500")) {
                                ...
                                buildDialogdatachanged(context, "Please Choose another name", "File already exists").show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String collection = viewZipList.collectionname;
